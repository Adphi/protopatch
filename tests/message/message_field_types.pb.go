...
type MessageWithRepeatedCustomType struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields

	RepeatedStringField []String `protobuf:"bytes,1,rep,name=repeated_string_field,json=repeatedStringField,proto3" json:"repeated_string_field,omitempty"`
}

func (x *MessageWithRepeatedCustomType) Reset() {
	*x = MessageWithRepeatedCustomType{}
	if protoimpl.UnsafeEnabled {
...
func (x *MessageWithRepeatedCustomType) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MessageWithRepeatedCustomType) ProtoMessage() {}

func (x *MessageWithRepeatedCustomType) ProtoReflect() protoreflect.Message {
	mi := &file_tests_message_message_field_types_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MessageWithRepeatedCustomType.ProtoReflect.Descriptor instead.
func (*MessageWithRepeatedCustomType) Descriptor() ([]byte, []int) {
	return file_tests_message_message_field_types_proto_rawDescGZIP(), []int{2}
}

func (x *MessageWithRepeatedCustomType) GetRepeatedStringField() []String {
	if x != nil {
...
var file_tests_message_message_field_types_proto_rawDesc = []byte{
	...
	,
...
var file_tests_message_message_field_types_proto_goTypes = []interface{}{
	...
	(*MessageWithOneOfCustomType)(nil),    // 1: tests.message.MessageWithOneOfCustomType
	(*MessageWithRepeatedCustomType)(nil), // 2: tests.message.MessageWithRepeatedCustomType
...
func file_tests_message_message_field_types_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_tests_message_message_field_types_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*MessageWithRepeatedCustomType); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
